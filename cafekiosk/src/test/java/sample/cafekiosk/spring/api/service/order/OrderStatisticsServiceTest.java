...
class OrderStatisticsServiceTest extends IntegrationTestSupport {
    ...
    void sendOrderStatisticsMail() {
        ...
        final Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2023, 3, 4, 23, 59, 59, 59), products);
        final Order order2 = createPaymentCompletedOrder(now, products);
        final Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2023, 3, 5, 23, 59, 59, 59), products);
        final Order order4 = createPaymentCompletedOrder(LocalDateTime.of(2023, 3, 6, 0, 0), products);
